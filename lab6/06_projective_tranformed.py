...
def main():
   ...
   #img = cv2.normalize(img, None, 0, 1, cv2.NORM_MINMAX, cv2.CV_32F)
    ...
    transformed = cv2.warpPerspective(img, perpective_tr, (np.int32(img.shape[1]*2/3),np.int32(img.shape[0]*4/3)))
    ...
    transformed = cv2.warpPerspective(img, perpective_tr, (img.shape[1]*2,img.shape[0]*2))
    plot_cv_img(transformed)
